...
export default function GoogleGeminiEffect({
  ...
  description = "Scroll down to find more information about me!",
  className = "",
  children
}) {
  return (
    <div className={`gge-sticky ${className}`}>
      {/*<h2 className="gge-title">{title}</h2>
      <p className="gge-desc">{description}</p>
      ...
      <svg className="gge-svg" viewBox="0 0 1440 1070"
        ...
        {/* --- FOREGROUND ANIMATED STROKES (rendered LAST so they're ON TOP) --- */}
        {D.map((d, i) => (
          <motion.path
            key={`anim-${i}`}
            d={d}
      ...
      <div className="gge-center-overlay">
